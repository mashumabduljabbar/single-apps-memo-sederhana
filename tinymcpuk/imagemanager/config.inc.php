...
*/
$IMConfig['base_dir'] = $_SERVER['DOCUMENT_ROOT'] . 'bbtel2/images/Image'; ///gambar/Image
...
*/
$IMConfig['base_url'] = 'http://' . $_SERVER['SERVER_NAME']  . 'bbtel2/images/Image'; //gambar/Image or /images/Image
